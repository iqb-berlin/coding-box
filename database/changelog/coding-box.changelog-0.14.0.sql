...
ALTER TABLE "public"."response" ADD COLUMN "coded_code_v1" INTEGER;
ALTER TABLE "public"."response" ADD COLUMN "coded_score_v1" INTEGER;
...
-- rollback ALTER TABLE "public"."response" DROP COLUMN IF EXISTS "coded_code_v1";
-- rollback ALTER TABLE "public"."response" DROP COLUMN IF EXISTS "coded_score_v1";
