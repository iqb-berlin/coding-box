...
describe('ValidationTaskRunnerService', () => {
  ...
  describe('runTask', () => {
    it('should create task, poll it, and return result', fakeAsync(() => {
      ...
      validationServiceMock.pollValidationTask.mockReturnValue(of(mockCompletedTask));
      ...
      expect(validationServiceMock.createValidationTask).toHaveBeenCalledWith(mockWorkspaceId, 'variables', undefined, undefined, undefined);
      expect(validationServiceMock.pollValidationTask).toHaveBeenCalledWith(mockWorkspaceId, 123, 2000);
      expect(validationServiceMock.getValidationResults).toHaveBeenCalledWith(mockWorkspaceId, 123);
    }));
    ...
    it('should throw error if task fails', done => {
      ...
      validationServiceMock.createValidationTask.mockReturnValue(of(mockCreatedTask));
      validationServiceMock.pollValidationTask.mockReturnValue(of(mockFailedTask));
  ...
  describe('runDeleteResponsesTask', () => {
    it('should run delete task', fakeAsync(() => {
      ...
      validationServiceMock.createDeleteResponsesTask.mockReturnValue(of(mockTask));
