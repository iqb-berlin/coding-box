import {
  DEFAULT_AUTH_SESSION_IDLE_TIMEOUT_MINUTES as SHARED_DEFAULT_AUTH_SESSION_IDLE_TIMEOUT_MINUTES,
  DEFAULT_EXTERNAL_REPLAY_TOKEN_DURATION_DAYS as SHARED_DEFAULT_EXTERNAL_REPLAY_TOKEN_DURATION_DAYS
} from '../../../../../../api-dto/workspaces/workspace-setting-defaults';

export const DEFAULT_AUTH_SESSION_IDLE_TIMEOUT_MINUTES =
  SHARED_DEFAULT_AUTH_SESSION_IDLE_TIMEOUT_MINUTES;
...
export const DEFAULT_EXTERNAL_REPLAY_TOKEN_DURATION_DAYS =
  SHARED_DEFAULT_EXTERNAL_REPLAY_TOKEN_DURATION_DAYS;
