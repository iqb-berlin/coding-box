...
@Component({
  ...
  imports: [MatFormFieldModule, MatInputModule, MatButtonModule, ReactiveFormsModule, NgIf, TranslateModule, UnitPlayerComponent, UploadResultsButtonComponent, AppInfoComponent],
