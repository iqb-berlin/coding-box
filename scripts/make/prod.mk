...
coding-box-export-backend-vol:
	...
	docker run --rm\
		...
		busybox tar cvzf /tmp/backend_vol.tar.gz /usr/src/coding-box-backend/packages
...
coding-box-import-backend-vol:
	...
	docker run --rm\
			...
			--volume $(CODING_BOX_BASE_DIR)/backup/temp:/tmp\
		busybox sh\
			-c "cd /usr/src/coding-box-backend/packages && tar xvzf /tmp/backend_vol.tar.gz --strip-components 4"
