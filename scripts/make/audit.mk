...
audit-backend:
	docker compose --env-file $(CODING_BOX_BASE_DIR)/.env.dev exec -it backend npm audit --audit-level critical

## Run frontend audit (only in combination with 'make dev-up')
audit-frontend:
	docker compose --env-file $(CODING_BOX_BASE_DIR)/.env.dev exec -it frontend npm audit --audit-level critical
